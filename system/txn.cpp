...
#if CC_ALG == TICTOC || CC_ALG == SILO || CC_ALG == DIRTY_OCC
#if CC_ALG != DIRTY_OCC
...
#if CC_ALG != TICTOC && CC_ALG != SILO && CC_ALG != WOUND_WAIT && CC_ALG!= BAMBOO && CC_ALG != DIRTY_OCC
...
#if (CC_ALG == SILO || CC_ALG == TICTOC || CC_ALG == DIRTY_OCC)
